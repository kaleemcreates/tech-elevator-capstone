...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHnTrqf_-ymPuHiz1UhbRUJCblHG2X3a8&sensor=false">
</script>
...
<div id="map_canvas" style="width-min: 300px; height: 350px; position: relative; background-color: rgb(229, 227, 223);">
	...
	<div>
        <select id="type" >
            <option value="">Please select category</option>
            <option value='Sports' id="type">Sports</option>
	 		<option value="Entertainment" >Entertainment</option>
	 		<option value="Shopping">Shopping</option>
	 		<option value="Restaurant">Restaurant</option>
        </select>
    ...
    function ($scope, $http, $compile) { 
       <c:set var="count" value="0" scope="page" />
    	  $scope.find = function () {
    	   ...
    	   // Our markers
    	   markers1 = [
    	        ['0', 'Madivala', 39.965741, -83.02, 'Sports'], 
           ...
           filterMarkers = function (category) {
               for (i = 0; i < markers1.length; i++) {
                   ...
                   if (marker.category.indexOf(category) > -1 || category.length === 0) {
